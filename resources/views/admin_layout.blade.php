                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username">
                                <?php
                                $name = Auth::guard('admins')->user()->admin_name;
                                if ($name) {
                                    echo $name;
                                }
                                ?>
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ URL::to('/all-post') }}">Liệt kê bài viết</a></li>
            ...
            $('.btn-reply-comment').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#notify_comment').html(
                            '<span class="text text-alert">Trả lời ý kiến khách hàng thành công</span>'
                        );
                        $('#notify_comment').fadeOut(100000);
                    }
                    // Trả lời ý kiến khách hàng
                });
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var chart = new Morris.Bar({
                ...
                element: 'chart',
                //option chart
                lineColors: ['#f714b7', '#fc8710', '#FF6541', '#A4ADD3', '#766B56'],
                parseTime: false,
                hideHover: 'auto',
                xkey: 'period',
