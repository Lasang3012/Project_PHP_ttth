        ...
        <div class="col-md-12">
            ...
            <div class="row" style="background: cadetblue;padding: 15px">
                ...
                <div class="col-md-6" style="text-align: center;color: #fff;font-weight: bold;font-size: 30px">
                    <h4 style="margin:0">CÔNG TY BÁN GIẦY LARAVEL</h4>
                ...
                <div class="col-md-12">
                    <p style="color:#fff;font-size: 17px;">
                        Bạn hoặc một ai đó đã đăng ký dịch vụ tại shop với thông tin như sau:
                    </p>
                    ...
                    <p>
                        Mã đơn hàng :
                        <strong style="text-transform: uppercase;color:#fff">
                            {{ $code['order_code'] }}
                        </strong>
                    </p>
                    <p>
                ...
                <p style="color:#fff">Mọi chi tiết xin liên hệ website tại : <a target="_blank" href="#">Shop</a>, hoặc
                    liên hệ qua số hotline : 19005689.Xin cảm ơn quý khách đã đặt hàng shop chúng tôi.</p>
