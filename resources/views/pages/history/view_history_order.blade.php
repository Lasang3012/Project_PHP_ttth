                            ...
                            <td colspan="6">
                                ...
                                @if ($coupon_condition == 1)
                                    @php
                                        ...
                                        echo 'Tổng giảm :' . number_format($total_after_coupon, 0, ',', '.') . ' do đã sử dụng mã giảm giá có giá trị là :.' . $coupon_number . '% </br>';
                                        $total_coupon = $total + $details->product_feeship - $total_after_coupon;
                                    @endphp
                                @else
                                    @php
                                        echo 'Tổng giảm :' . number_format($coupon_number, 0, ',', '.') . 'do đã sử dụng mã giảm giá có giá trị là : '.$coupon_number.'k' . '</br>';
