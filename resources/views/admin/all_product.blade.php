        ...
        <div class="panel panel-default">
            ...
            <div class="row w3-res-tb">
                <div class="col-sm-5 m-b-xs">
                    ...
                    <button class="btn btn-sm btn-default" ><a href="{{URL::asset('/add-product')}}" style="decoration: none; color: black">Thêm sản phẩm</a> </button>
                </div>
                <div class="col-sm-2">
                </div>
                <div class="col-sm-5">
            ...
            <footer class="panel-footer">
                <div class="row">
                    ...
                    <div class="col-sm-5 text-center">
                        <small class="text-muted inline m-t-sm m-b-sm">Hiển thị 5 trên tổng số sản phẩm trong một slide</small>
                    </div>
