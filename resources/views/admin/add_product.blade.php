            ...
            <section class="panel">
                ...
                <div class="row w3-res-tb">
                    <div class="col-sm-5 m-b-xs">
                        ...
                        <button class="btn btn-sm btn-default" ><a href="{{URL::asset('/all-product')}}" style="decoration: none; color: black">Danh sách sản phẩm</a> </button>
                    </div>
                    <div class="col-sm-4">
                    </div>
                    {{-- <div class="col-sm-3">
                        ...
                        <form role="form" action="{{ URL::to('/save-product') }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" data-validation="length" data-validation-length="min10"
                                    ...
                                    class="form-control " id="slug" placeholder="Tên danh mục" onkeyup="ChangeToSlug();">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" data-validation="number" data-validation-error-msg="Làm ơn điền số tiền"
                                    name="product_price" class="form-control" id="" placeholder="Tên danh mục">
                            </div>
                            <div class="form-group">
