	...
	<div class="container" style="background: #222;border-radius: 12px;padding:15px;">
		<div class="col-md-12" >
			...
			<div class="row" style="background: #ff66cc;padding: 15px">
				...
				<p style="color:#fff;text-align: center;font-size: 15px;">Mọi chi tiết xin liên hệ website tại : <a target="_blank" href="#">Shop</a>, hoặc liên hệ qua số hotline : 19005689.Xin cảm ơn quý khách đã đặt hàng shop chúng tôi.</p>
