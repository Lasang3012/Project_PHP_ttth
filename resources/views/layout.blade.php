...
<head>
    ...
    <link href="{{ asset('public/frontend/css/contact_form.css') }}" rel="stylesheet">
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                ...
                                <li><a href="#"><i class="fa fa-envelope"></i> thanhsang@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="shop-menu pull-right">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{{ url('/dang-nhap') }}">Đăng ký</a></li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="index.html"><img src="{{ 'public/frontend/images/home/logo.png' }}"
                                    alt="" /></a>
                        </div>
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                {{-- <li><a href="{{ url('/gio-hang') }}"><i class="fa fa-cart-plus"
                                            style="font-size:24px"></i>
                                        <span class='badge badge-warning' id='lblCartCount'> {{ Cart::count() }}
                                        </span></a></li> --}}
                                {{-- <li>
                                ...
                                <li>
                                    <a href="{{ URL::to('history') }}"><i class="fa fa-bell"></i> Lịch sử đơn hàng
                                    </a>
                                ...
                                <li class="wrap-icon-section minicart" id="show-cart-menu">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="companyinfo">
                            ...
                            <p>Shop bán giầy chất lượng nhất ở Việt Nam</p>
                        </div>
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-3 col-sm-offset-1">
                        <div class="single-widget">
                            ...
                            <form action="#" class="searchform">
                                ...
                                <p>Nhận các bản cập nhật gần đây nhất từ <br />trang của chúng tôi và được cập nhật bản
                                    thân của bạn ...</p>
                            </form>
                        </div>
                    </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    ...
                    <p class="pull-right">Thiết kế bởi <span><a target="_blank"
                                href="{{ URL::to('/login-auth') }}">Thành Sang</a></span></p>
                </div>
            </div>
        </div>
            ...
            $('.send-comment').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#notify_comment').html(
                            '<span class="text text-success">Thêm ý kiền thành công,ý kiến của bạn sẽ được phản hồi</span>'
                            );
                        load_comment();
