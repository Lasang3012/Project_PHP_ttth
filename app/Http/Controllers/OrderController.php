...
class OrderController extends Controller
{
    ...
    public function update_order_qty(Request $request)
    {
        ...
        // gửi mail đến tên mail mà khách hàng đã điền mail trong khi đặt hàng
    ...
    public function history(Request $request)
    {
        ...
        if (!Session::get('customer_id')) {
            ...
            return view('pages.history.history')->with('category', $cate_product)->with('brand', $brand_product)->with('meta_desc', $meta_desc)->with('meta_keywords', $meta_keywords)->with('meta_title', $meta_title)->with('url_canonical', $url_canonical)->with('slider', $slider)->with('getorder', $getorder)->with('category_post', $category_post); //1
